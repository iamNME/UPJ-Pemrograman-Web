...
<head>
    ...
    <meta name="description"
          content="Admin login page for Jabarul Alqodri portfolio website">
    <meta name="author" content="Jabarul Alqodri">

    <!-- OG Meta Tags to improve the way the post looks when you share the page on LinkedIn, Facebook, Google+ -->
    <meta property="og:site_name" content="KUMBAYA"/> <!-- website name -->
    <meta property="og:site" content=""/> <!-- website link -->
    <meta property="og:title" content="Admin login page for Jabarul Alqodri portfolio website"/> <!-- title shown in the actual shared post -->
        ...
        <div class="container-fluid">
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-12 col-md-7 col-lg-6 col-xl-8 d-none d-lg-block">
                    <!-- Image -->
                    <div class="bg-cover vh-100 ml-n3 gradient-overlay" style="background-image: url(img/hero-bg-1.jpg);">
                ...
                <div class="col-12 col-md-6 col-lg-6 col-xl-4">
                    <div class="login-signup-wrap px-4 px-lg-5 my-5">
                        ...
                        <!--login form-->
                        <form class="login-signup-form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">

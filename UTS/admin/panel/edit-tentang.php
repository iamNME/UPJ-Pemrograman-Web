        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="tentang-saya.php">Data tentang</a></li>
            ...
            <div class="card-header pr-4 pl-4">
              ...
              <!-- form start -->
    					  ...
    					  if($_SERVER['REQUEST_METHOD'] == "POST"){
    					      ...
    					      $sql = "UPDATE tentangsaya SET namalengkap='$namaLengkap', judul='$judul', isi='$isi' WHERE id='$id'";
                      ...
                      <div class="container pl-4 pr-3 pt-4">
    					...
    					<?php
    					        ...
    					        if(isset($_GET['id'])){
    					            ...
    					            $sql = "SELECT * FROM tentangsaya WHERE id='$id'";
    					            $query = mysqli_query($conn, $sql);
              ...
              <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                <div class="card-body pr-4 pl-4">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="namalengkap" value="<?= $namaLengkap ?>" class="form-control" id="namalengkap" placeholder="Nama Lengkap" required>
                    </div>
                  </div>
                  <div class="form-group row">
										<label for="judul" class="col-sm-2 col-form-label">Judul</label>
                    <div class="col-sm-10">
                      <input type="text" name="judul" value="<?= $judul ?>" class="form-control" id="judul" placeholder="Judul" required>
                    </div>
                  </div>
									<div class="form-group row">

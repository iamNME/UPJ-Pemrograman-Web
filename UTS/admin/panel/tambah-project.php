            ...
            <div class="card-header pr-4 pl-4">
              ...
              <!-- form start -->
    					  ...
    					  if($_SERVER['REQUEST_METHOD'] == "POST"){
    					    ...
    					    $sql = "INSERT INTO portfolio (id, judulproject, link, gambar, deskripsi) VALUES ('$id', '$judulProject', '$link', '$gambar', '$deskripsi')";
              ...
              <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                <div class="card-body pr-4 pl-4">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="judulproject" class="form-control" id="judulproject" placeholder="Judul Project" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="link" class="col-sm-2 col-form-label">Link Project</label>
                    <div class="col-sm-10">
                      <input type="text" name="link" class="form-control" id="link" placeholder="Link Project" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="gambar" class="col-sm-2 col-form-label">Gambar Project</label>
                    <div class="col-sm-10 custom-file">
                      <input type="file" name="gambar" value="" class="custom-file-input form-label" id="gambar">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
											<textarea id="summernote" name="deskripsi" class="form-control"></textarea>
                    </div>
                  </div>

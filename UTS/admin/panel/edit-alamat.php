        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="contact-alamat.php">Data Alamat</a></li>
            ...
            <div class="card-header pr-4 pl-4">
              ...
              <!-- form start -->
    					  ...
    					  if($_SERVER['REQUEST_METHOD'] == "POST"){
    					      ...
    					      $sql = "UPDATE alamat SET alamat='$alamat' WHERE id='$id'";
              ...
              <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                <div class="card-body pr-4 pl-4">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="alamat" value="<?= $alamat ?>" class="form-control" id="alamat" placeholder="Alamat" required>
                    </div>
                  </div>

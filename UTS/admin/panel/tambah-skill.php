            ...
            <div class="card-header pr-4 pl-4">
              ...
              <!-- form start -->
    					  ...
    					  if($_SERVER['REQUEST_METHOD'] == "POST"){
    					    ...
    					    $sql = "INSERT INTO skill (id, judulskill, progress) VALUES ('$id', '$judulSkill', '$progress')";
              ...
              <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                <div class="card-body pr-4 pl-4">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="judulskill" class="form-control" id="judulskill" placeholder="Judul Skill" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="progress" class="col-sm-2 col-form-label">Progress</label>
                    <div class="col-sm-10">
                      <input type="text" name="progress" class="form-control" id="progress" placeholder="Progress" required>
                    </div>
                  </div>

            ...
            <div class="card-header pr-4 pl-4">
              ...
              <!-- form start -->
    					  ...
    					  if($_SERVER['REQUEST_METHOD'] == "POST"){
    					      ...
    					      $sql = "UPDATE hubungisaya SET number='$nomor' WHERE id='$id'";
    					...
    					<?php
    					        ...
    					        if(isset($_GET['id'])){
    					            ...
    					            $sql = "SELECT * FROM hubungisaya WHERE id='$id'";
    					            $query = mysqli_query($conn, $sql);
              ...
              <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                <div class="card-body pr-4 pl-4">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="nomor" value="<?= $nomor ?>" class="form-control" id="nomor" placeholder="Nomor" required>
                    </div>
                  </div>

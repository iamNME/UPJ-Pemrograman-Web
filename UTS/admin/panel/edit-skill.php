        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="skill.php">Data Skill</a></li>
            ...
            <div class="card-header pr-4 pl-4">
              ...
              <!-- form start -->
    					  ...
    					  if($_SERVER['REQUEST_METHOD'] == "POST"){
										$id = $_POST['id'];
    					      $judulSkill = $_POST['judulskill'];
    					      $progress = $_POST['progress'];
								
    					      $sql = "UPDATE skill SET judulskill='$judulSkill', progress='$progress' WHERE id='$id'";
              ...
              <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                <div class="card-body pr-4 pl-4">
                  ...
                  <div class="form-group row">
                    <label for="judulskill" class="col-sm-2 col-form-label">Skill Title</label>
                    <div class="col-sm-10">
                      <input type="text" name="judulskill" value="<?= $judulSkill ?>" class="form-control" id="judulskill" placeholder="Judul Skill" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="progress" class="col-sm-2 col-form-label">Progress</label>
                    <div class="col-sm-10">
                      <input type="text" name="progress" value="<?= $progress ?>" class="form-control" id="progress" placeholder="Progress" required>
                    </div>
                  </div>
